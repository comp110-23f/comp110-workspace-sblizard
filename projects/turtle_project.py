...
def draw_rect(turt: Turtle, top_left: list[float], bottom_right: list[float]) -> None:
...
def draw_mount(turt: Turtle, bottom_left: list[float], bottom_right:list[float], peak_pos: list[float]) -> None:
    turt.penup()
